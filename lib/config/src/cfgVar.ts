...
export const number =
    (defaultValue: number): Overrider<number> =>
    (override) => {
...
export const numberOrNull =
    (defaultValue: number | null): Overrider<number | null> =>
    (override) => {
        if (override === undefined) {
            return defaultValue;
        }
...
// TODO: грязно
export const string =
    <T = string>(defaultValue: T): Overrider<T> =>
    (override) => {
        if (override !== undefined) {
...
export const stringOrBoolean =
    <T extends string>(defaultValue: T | boolean): Overrider<T | boolean> =>
    (override) => {
        if (override === undefined) {
            return defaultValue;
        }
...
export const stringOrNull =
    <T extends string>(defaultValue: T | null): Overrider<T | null> =>
    (override) => {
        if (override === undefined) {
            return defaultValue;
        }
...
export const boolean =
    (defaultValue: boolean): Overrider<boolean> =>
    (override) => {
        if (override === 'true') {
            return true;
        }
